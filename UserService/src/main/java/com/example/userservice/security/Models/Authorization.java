...
public class Authorization {
    // During the OAuth 2.0 authorization process, tokens (like authorization codes, access tokens, and refresh tokens)
    // are issued to clients after successful authorization.
    // This entity keeps a record of those tokens and other related information.

    // By storing the expiration and issuance times, your system can enforce expiration policies and
    // prevent misuse of tokens (e.g., when tokens expire, they are no longer valid).
    @Id
    @Column
    private String id;
    private String registeredClientId;
    // References the client (from the Client entity) to whom this authorization was granted.
    // The client may represent a third-party application
    private String principalName;
    private String authorizationGrantType;
    // Specifies the OAuth 2.0 grant type used for this authorization
